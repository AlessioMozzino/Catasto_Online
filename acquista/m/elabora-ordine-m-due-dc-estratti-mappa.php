<?php
    ...
    if(isset($_POST['ordina-m-due-dc-estratti-mappa'])) {
		...
		$riferimenti_geografici_provincia_immboili_1_2 = $riferimenti_geografici_ord_pro_db_immobile_1 . ' / ' . $riferimenti_geografici_ord_pro_db_immobile_2;
		$riferimenti_geografici_comune_immobili_1_2 = $riferimenti_geografici_ord_com_db_immobile_1 . ' / ' . $riferimenti_geografici_ord_com_db_immobile_2;
		...
		VALUES ('$ord_pb', '$ord_sm', '', '$ord_catasto_imm_1_2', '$ord_pln', '$ord_vio', '$ord_vis', '$ord_map', '$ord_arr', '$urg_name', '$ord_sca', '$ord_token', '$cli_id', '$cliente_titolare_delegato', '$riferimenti_geografici_provincia_immboili_1_2', '$riferimenti_geografici_comune_immobili_1_2', '$su_immobili_1_2', '$fgl_immobili_1_2', '$par_immobili_1_2', '$sub_immobili_1_2', '$ord_stat', '$ord_price', '$ord_price_eff_finale', '$tributi_catastali_totali', '$spese_finanziarie', '$tasse_contributi', '$profitto_netto', '$ord_deb_cont', '$metodo_pagamento')";
