<?php
    ...
    /* Ordinazione planimetrie catastali */
    if(isset($_POST['ordina-m-tre-sc-planimetria-catastale'])) {
		...
		/* Recupero riferimenti catastali immobile 3 */
		...
		/* Unione dati catastali per inserimento nel database */
		$sezione_urbana_immobili_1_2_3 = $riferimenti_catastali_ord_su_db_immobile_1 . " / " . $riferimenti_catastali_ord_su_db_immobile_2 . ' / ' . $riferimenti_catastali_ord_su_db_immobile_3;
		$foglio_immobili_1_2_3 = $riferimenti_catastali_fgl_immobile_1 . " / " . $riferimenti_catastali_fgl_immobile_2 . ' / ' . $riferimenti_catastali_fgl_immobile_3;
		$particella_immobili_1_2_3 = $riferimenti_catastali_par_immobile_1 . " / " . $riferimenti_catastali_par_immobile_2 . ' / ' . $riferimenti_catastali_par_immobile_3;
		$subalterno_immobili_1_2_3 = $riferimenti_catastali_sub_immobile_1 . " / " . $riferimenti_catastali_sub_immobile_2 . ' / ' . $riferimenti_catastali_sub_immobile_3;
		...
		$prezzo_planimetrie_catastali = $price_pln * 3;

		/* Controllo spunte servizi aggiuntivi per conferma prezzo finale ordine */
		/* Visura ordinaria immobile 1 */
		if(isset($_POST['ordine-planimetria-visura-ordinaria-immobile-1'])) {
		...
		if(isset($_POST['ordine-planimetria-visura-ordinaria-immobile-2'])) {
			$prezzo_visura_ordinaria += $price_vio;
			/* Determinazione tributo catastale */
			$tributo_catastale_visura_ordinaria += $price_tc_vio;
			/* Definizione ord_vio (S / N) */
		...
		if(isset($_POST['ordine-planimetria-visura-ordinaria-immobile-3'])) {
			$prezzo_visura_ordinaria += $price_vio;
			/* Determinazione tributo catastale */
			$tributo_catastale_visura_ordinaria += $price_tc_vio;
			/* Definizione ord_vio (S / N) */
		...
		if(isset($_POST['ordine-planimetria-visura-storica-immobile-1'])) {
		...
		if(isset($_POST['ordine-planimetria-visura-storica-immobile-2'])) {
			$prezzo_visura_storica += $price_vis;
			/* Determinazione tributo catastale */
			$tributo_catastale_visura_storica += $price_tc_vis;
			/* Definizione ord_vis (S / N) */
		...
		if(isset($_POST['ordine-planimetria-visura-storica-immobile-3'])) {
			$prezzo_visura_storica += $price_vis;
			/* Determinazione tributo catastale */
			$tributo_catastale_visura_storica += $price_tc_vis;
			/* Definizione ord_vis (S / N) */
		...
		if(isset($_POST['ordine-planimetria-estratto-mappa-immobile-1'])) {
		...
		if(isset($_POST['ordine-planimetria-estratto-mappa-immobile-2'])) {
			$prezzo_estratto_mappa += $price_map;
			/* Determinazione tributo catastale */
			$tributo_catastale_estratto_mappa += $price_tc_map;
			/* Definizione ord_map (S / N) */
		...
		if(isset($_POST['ordine-planimetria-estratto-mappa-immobile-3'])) {
			$prezzo_estratto_mappa += $price_map;
			/* Determinazione tributo catastale */
			$tributo_catastale_estratto_mappa += $price_tc_map;
			/* Definizione ord_map (S / N) */
		...
		$ord_price = round($prezzo_planimetrie_catastali + $prezzo_visura_ordinaria + $prezzo_visura_storica + $prezzo_estratto_mappa, 2);
		...
		$tributi_catastali_totali = round($tributo_catastale_visura_ordinaria + $tributo_catastale_visura_storica + $tributo_catastale_estratto_mappa, 2);
		...
		/* Definizione di catasto: FABBRICATI */
		$ord_catasto = 'F / F / F';
		...
		VALUES ('$ord_pb', '$ord_sm', '', '$ord_catasto', '$ord_pln', '$ord_vio', '$ord_vis', '$ord_map', '$ord_arr', '$urg_name', '$ord_sca', '$ord_token', '$cli_id', '$cliente_titolare_delegato', '$riferimenti_geografici_ord_pro_db', '$riferimenti_geografici_ord_com_db', '$sezione_urbana_immobili_1_2_3', '$foglio_immobili_1_2_3', '$particella_immobili_1_2_3', '$subalterno_immobili_1_2_3', '$ord_stat', '$ord_price', '$ord_price_eff_finale', '$tributi_catastali_totali', '$spese_finanziarie', '$tasse_contributi', '$profitto_netto', '$ord_deb_cont', '$metodo_pagamento')";
