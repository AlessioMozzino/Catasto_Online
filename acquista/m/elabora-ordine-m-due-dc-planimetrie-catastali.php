<?php
    ...
    if(isset($_POST['ordina-m-due-dc-planimetria-catastale'])) {
		...
		$riferimenti_geografici_provincia_immobili_1_2 = $riferimenti_geografici_ord_pro_db_immobile_1 . ' / ' . $riferimenti_geografici_ord_pro_db_immobile_2;
		...
		VALUES ('$ord_pb', '$ord_sm', '', '$ord_catasto', '$ord_pln', '$ord_vio', '$ord_vis', '$ord_map', '$ord_arr', '$urg_name', '$ord_sca', '$ord_token', '$cli_id', '$cliente_titolare_delegato', '$riferimenti_geografici_provincia_immobili_1_2', '$riferimenti_geografici_comune_immobili_1_2', '$sezione_urbana_immobili_1_2', '$foglio_immobili_1_2', '$particella_immobili_1_2', '$subalterno_immobili_1_2', '$ord_stat', '$ord_price', '$ord_price_eff_finale', '$tributi_catastali_totali', '$spese_finanziarie', '$tasse_contributi', '$profitto_netto', '$ord_deb_cont', '$metodo_pagamento')";
