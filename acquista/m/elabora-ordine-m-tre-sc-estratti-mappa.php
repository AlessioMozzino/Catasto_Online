<?php
    ...
    /* Ordinazione estratti di mappa */
    if(isset($_POST['ordina-m-tre-sc-estratti-mappa'])) {
		...
		/* Provincia ID */
		$riferimenti_geografici_pro_id = $_POST['rif-geografici-provincia'];

		/* Recupero nome provincia da ID */
		$query_recupero_nome_provincia = "SELECT pro_name FROM tabella_province WHERE pro_id = '$riferimenti_geografici_pro_id'";
		$record_recupero_nome_provincia = $query_connection->query($query_recupero_nome_provincia);
		$campo_recupero_nome_provincia = $record_recupero_nome_provincia->fetch_assoc();
		$riferimenti_geografici_ord_pro_db = addslashes($campo_recupero_nome_provincia['pro_name']);

		/* Comune ID */
		$riferimenti_geografici_com_id = $_POST['rif-geografici-comune'];

		/* Recupero nome comune da ID */
		$query_recupero_nome_comune = "SELECT com_name FROM tabella_comuni WHERE com_id = '$riferimenti_geografici_com_id'";
		$record_recupero_nome_comune = $query_connection->query($query_recupero_nome_comune);
		$campo_recupero_nome_comune = $record_recupero_nome_comune->fetch_assoc();
		$riferimenti_geografici_ord_com_db = addslashes($campo_recupero_nome_comune['com_name']);

		/* Recupero riferimenti catastali */
		/* Sezione urbana ID immobile 1 */
		$riferimenti_catastali_su_id_1 = $_POST['rif-catastali-su-immobile-1'];

		/* Recupero nome sezione urbana da ID immobile 1 */
		$query_recupero_nome_su_imm_1 = "SELECT su_name FROM tabella_su WHERE su_id = '$riferimenti_catastali_su_id_1'";
		$record_recupero_nome_su_imm_1 = $query_connection->query($query_recupero_nome_su_imm_1);
		$campo_recupero_nome_su_imm_1 = $record_recupero_nome_su_imm_1->fetch_assoc();
		$riferimenti_catastali_ord_su_db_imm_1 = addslashes($campo_recupero_nome_su_imm_1['su_name']);

		$riferimenti_catastali_fgl_imm_1 = addslashes($_POST['rif-catastali-foglio-immobile-1']);
		$riferimenti_catastali_par_imm_1 = addslashes($_POST['rif-catastali-particella-immobile-1']);
		$riferimenti_catastali_sub_imm_1 = addslashes($_POST['rif-catastali-subalterno-immobile-1']);
				
		if(!$riferimenti_catastali_sub_imm_1) {
			$riferimenti_catastali_sub_imm_1 = '0';
		}
		
		/* Sezione urbana ID immobile 2 */
		$riferimenti_catastali_su_id_2 = $_POST['rif-catastali-su-immobile-2'];

		/* Recupero nome sezione urbana da ID immobile 1 */
		$query_recupero_nome_su_imm_2 = "SELECT su_name FROM tabella_su WHERE su_id = '$riferimenti_catastali_su_id_2'";
		$record_recupero_nome_su_imm_2 = $query_connection->query($query_recupero_nome_su_imm_2);
		$campo_recupero_nome_su_imm_2 = $record_recupero_nome_su_imm_2->fetch_assoc();
		$riferimenti_catastali_ord_su_db_imm_2 = addslashes($campo_recupero_nome_su_imm_2['su_name']);

		$riferimenti_catastali_fgl_imm_2 = addslashes($_POST['rif-catastali-foglio-immobile-2']);
		$riferimenti_catastali_par_imm_2 = addslashes($_POST['rif-catastali-particella-immobile-2']);
		$riferimenti_catastali_sub_imm_2 = addslashes($_POST['rif-catastali-subalterno-immobile-2']);
				
		if(!$riferimenti_catastali_sub_imm_2) {
			$riferimenti_catastali_sub_imm_2 = '0';
		}
		
		/* Sezione urbana ID immobile 3 */
		$riferimenti_catastali_su_id_3 = $_POST['rif-catastali-su-immobile-3'];

		/* Recupero nome sezione urbana da ID immobile 3 */
		$query_recupero_nome_su_imm_3 = "SELECT su_name FROM tabella_su WHERE su_id = '$riferimenti_catastali_su_id_3'";
		$record_recupero_nome_su_imm_3 = $query_connection->query($query_recupero_nome_su_imm_3);
		$campo_recupero_nome_su_imm_3 = $record_recupero_nome_su_imm_3->fetch_assoc();
		$riferimenti_catastali_ord_su_db_imm_3 = addslashes($campo_recupero_nome_su_imm_3['su_name']);

		$riferimenti_catastali_fgl_imm_3 = addslashes($_POST['rif-catastali-foglio-immobile-3']);
		$riferimenti_catastali_par_imm_3 = addslashes($_POST['rif-catastali-particella-immobile-3']);
		$riferimenti_catastali_sub_imm_3 = addslashes($_POST['rif-catastali-subalterno-immobile-3']);
				
		if(!$riferimenti_catastali_sub_imm_3) {
			$riferimenti_catastali_sub_imm_3 = '0';
		}
		
		$su_immobili_1_2_3 = $riferimenti_catastali_ord_su_db_imm_1 . ' / ' . $riferimenti_catastali_ord_su_db_imm_2 . ' / ' . $riferimenti_catastali_ord_su_db_imm_3;
		$fgl_immobili_1_2_3 = $riferimenti_catastali_fgl_imm_1 . ' / ' . $riferimenti_catastali_fgl_imm_2 . ' / ' . $riferimenti_catastali_fgl_imm_3;
		$par_immobili_1_2_3 = $riferimenti_catastali_par_imm_1 . ' / ' . $riferimenti_catastali_par_imm_2 . ' / ' . $riferimenti_catastali_par_imm_3;
		$sub_immobili_1_2_3 = $riferimenti_catastali_sub_imm_1 . ' / ' . $riferimenti_catastali_sub_imm_2 . ' / ' . $riferimenti_catastali_sub_imm_3;
		...
		$prezzo_estratto_mappa = $price_map * 3;
		$tributo_catastale_mappa = $price_tc_map * 3;

		/* Controllo spunte servizi aggiuntivi per conferma prezzo finale ordine */
		/* Visura ordinaria immobile 1 */
		if(isset($_POST['ordine-mappa-visura-ordinaria-immobile-1'])) {
			$prezzo_visura_ordinaria = $price_vio;
			/* Determinazione tributo catastale */
			$tributo_catastale_visura_ordinaria = $price_tc_vio;
			/* Definizione ord_vio (S / N) */
			$ord_vio = "S / ";
		} else {
			$prezzo_visura_ordinaria = 0.00;
			/* Determinazione tributo catastale */
			$tributo_catastale_visura_ordinaria = 0.00;
			/* Definizione ord_vio (S / N) */
			$ord_vio = "N / ";
		}
		
		/* Visura ordinaria immobile 2 */
		if(isset($_POST['ordine-mappa-visura-ordinaria-immobile-2'])) {
			$prezzo_visura_ordinaria += $price_vio;
			/* Determinazione tributo catastale */
			$tributo_catastale_visura_ordinaria += $price_tc_vio;
			/* Definizione ord_vio (S / N) */
		...
		/* Visura ordinaria immobile 3 */
		if(isset($_POST['ordine-mappa-visura-ordinaria-immobile-3'])) {
			$prezzo_visura_ordinaria += $price_vio;
			/* Determinazione tributo catastale */
			$tributo_catastale_visura_ordinaria += $price_tc_vio;
			/* Definizione ord_vio (S / N) */
		...
		if(isset($_POST['ordine-mappa-visura-storica-immobile-1'])) {
		...
		if(isset($_POST['ordine-mappa-visura-storica-immobile-2'])) {
			$prezzo_visura_storica += $price_vis;
			/* Determinazione tributo catastale */
			$tributo_catastale_visura_storica += $price_tc_vis;
			/* Definizione ord_vis (S / N) */
		...
		if(isset($_POST['ordine-mappa-visura-storica-immobile-3'])) {
			$prezzo_visura_storica += $price_vis;
			/* Determinazione tributo catastale */
			$tributo_catastale_visura_storica += $price_tc_vis;
			/* Definizione ord_vis (S / N) */
		...
		if(isset($_POST['ordine-mappa-planimetria-immobile-1'])) {
		...
		if(isset($_POST['ordine-mappa-planimetria-immobile-2'])) {
			$prezzo_planimetria_catastale += $price_pln;
			/* Determinazione tributo catastale */
			$tributo_catastale_planimetria += $price_tc_pln;
			/* Definizione ord_map (S / N) */
		...
		if(isset($_POST['ordine-mappa-planimetria-immobile-3'])) {
			$prezzo_planimetria_catastale += $price_pln;
			/* Determinazione tributo catastale */
			$tributo_catastale_planimetria += $price_tc_pln;
			/* Definizione ord_map (S / N) */
		...
		$tributi_catastali_totali = round($tributo_catastale_mappa + $tributo_catastale_visura_ordinaria + $tributo_catastale_visura_storica + $tributo_catastale_planimetria, 2);
		...
		$ord_catasto_imm_1 = $_POST['tip-catasto-immobile-1'];
		/* Definizione di catasto immobile 2 */
		$ord_catasto_imm_2 = $_POST['tip-catasto-immobile-2'];
		/* Definizione di catasto immobile 2 */
		$ord_catasto_imm_3 = $_POST['tip-catasto-immobile-3'];
		
		/* Tipologia catasto immobili 1, 2 e 3 */
		$ord_catasto_imm_1_2_3 = $ord_catasto_imm_1 . ' / ' . $ord_catasto_imm_2 . ' / ' . $ord_catasto_imm_3;
		...
		VALUES ('$ord_pb', '$ord_sm', '', '$ord_catasto_imm_1_2_3', '$ord_pln', '$ord_vio', '$ord_vis', '$ord_map', '$ord_arr', '$urg_name', '$ord_sca', '$ord_token', '$cli_id', '$cliente_titolare_delegato', '$riferimenti_geografici_ord_pro_db', '$riferimenti_geografici_ord_com_db', '$su_immobili_1_2_3', '$fgl_immobili_1_2_3', '$par_immobili_1_2_3', '$sub_immobili_1_2_3', '$ord_stat', '$ord_price', '$ord_price_eff_finale', '$tributi_catastali_totali', '$spese_finanziarie', '$tasse_contributi', '$profitto_netto', '$ord_deb_cont', '$metodo_pagamento')";
