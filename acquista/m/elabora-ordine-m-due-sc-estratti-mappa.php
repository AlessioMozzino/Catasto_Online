<?php
    ...
    if(isset($_POST['ordina-m-due-sc-estratti-mappa'])) {
		...
		$su_immobili_1_2 = $riferimenti_catastali_ord_su_db_imm_1 . ' / ' . $riferimenti_catastali_ord_su_db_imm_2;
		$fgl_immobili_1_2 = $riferimenti_catastali_fgl_imm_1 . ' / ' . $riferimenti_catastali_fgl_imm_2;
		$par_immobili_1_2 = $riferimenti_catastali_par_imm_1 . ' / ' . $riferimenti_catastali_par_imm_2;
		$sub_immobili_1_2 = $riferimenti_catastali_sub_imm_1 . ' / ' . $riferimenti_catastali_sub_imm_2;
		...
		$prezzo_estratto_mappa = $price_map * 2;
		$tributo_catastale_mappa = $price_tc_map * 2;
		...
		/* Tipologia catasto immobili 1 e 2 */
		$ord_catasto_imm_1_2 = $ord_catasto_imm_1 . ' / ' . $ord_catasto_imm_2;
		...
		VALUES ('$ord_pb', '$ord_sm', '', '$ord_catasto_imm_1_2', '$ord_pln', '$ord_vio', '$ord_vis', '$ord_map', '$ord_arr', '$urg_name', '$ord_sca', '$ord_token', '$cli_id', '$cliente_titolare_delegato', '$riferimenti_geografici_ord_pro_db', '$riferimenti_geografici_ord_com_db', '$su_immobili_1_2', '$fgl_immobili_1_2', '$par_immobili_1_2', '$sub_immobili_1_2', '$ord_stat', '$ord_price', '$ord_price_eff_finale', '$tributi_catastali_totali', '$spese_finanziarie', '$tasse_contributi', '$profitto_netto', '$ord_deb_cont', '$metodo_pagamento')";
