<?php
    ...
    if(isset($_POST['ordina-m-tre-dc-estratti-mappa'])) {
		...
		VALUES ('$ord_pb', '$ord_sm', '', '$ord_catasto_imm_1_2_3', '$ord_pln', '$ord_vio', '$ord_vis', '$ord_map', '$ord_arr', '$urg_name', '$ord_sca', '$ord_token', '$cli_id', '$cliente_titolare_delegato', '$riferimenti_geografici_provincia_immobili_1_2_3', '$riferimenti_geografici_comune_immobili_1_2_3', '$su_immobili_1_2_3', '$fgl_immobili_1_2_3', '$par_immobili_1_2_3', '$sub_immobili_1_2_3', '$ord_stat', '$ord_price', '$ord_price_eff_finale', '$tributi_catastali_totali', '$spese_finanziarie', '$tasse_contributi', '$profitto_netto', '$ord_deb_cont', '$metodo_pagamento')";
