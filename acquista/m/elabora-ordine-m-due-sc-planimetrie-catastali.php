<?php
    ...
    if(isset($_POST['ordina-m-due-sc-planimetria-catastale'])) {
		...
		$sezione_urbana_immobili_1_2 = $riferimenti_catastali_ord_su_db_immobile_1 . " / " . $riferimenti_catastali_ord_su_db_immobile_2;
		$foglio_immobili_1_2 = $riferimenti_catastali_fgl_immobile_1 . " / " . $riferimenti_catastali_fgl_immobile_2;
		$particella_immobili_1_2 = $riferimenti_catastali_par_immobile_1 . " / " . $riferimenti_catastali_par_immobile_2;
		$subalterno_immobili_1_2 = $riferimenti_catastali_sub_immobile_1 . " / " . $riferimenti_catastali_sub_immobile_2;
		...
		$prezzo_planimetrie_catastali = $price_pln * 2;
