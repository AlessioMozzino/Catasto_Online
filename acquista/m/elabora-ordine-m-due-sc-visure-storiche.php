<?php
    ...
    /* Ordinazione visura storica */
    if(isset($_POST['ordina-m-due-sc-visure-storiche'])) {
		...
		$su_immobili_1_2 = $riferimenti_catastali_ord_su_db_immobile_1 . ' / ' . $riferimenti_catastali_ord_su_db_immobile_2;
		$fgl_immobili_1_2 = $riferimenti_catastali_fgl_immobile_1 . ' / ' . $riferimenti_catastali_fgl_immobile_2;
		$par_immobili_1_2 = $riferimenti_catastali_par_immobile_1 . ' / ' . $riferimenti_catastali_par_immobile_2;
		$sub_immobili_1_2 = $riferimenti_catastali_sub_immobile_1 . ' / ' . $riferimenti_catastali_sub_immobile_2;
		...
		$prezzo_visura_storica = $price_vis * 2;
		$tributo_catastale_visura_storica = $price_tc_vis * 2;

		/* Controllo spunte servizi aggiuntivi per conferma prezzo finale ordine */
		/* Estratto di mappa immobile 1 */
		if(isset($_POST['ordine-visura-storica-mappa-immobile-1'])) {
		...
		if(isset($_POST['ordine-visura-storica-mappa-immobile-2'])) {
			$prezzo_estratto_mappa += $price_map;
			/* Determinazione tributo catastale */
			$tributo_catastale_estratto_mappa += $price_tc_map;
			/* Definizione ord_vio (S / N) */
		...
		if(isset($_POST['ordine-visura-storica-visura-ordinaria-immobile-1'])) {
		...
		if(isset($_POST['ordine-visura-storica-visura-ordinaria-immobile-2'])) {
			$prezzo_visura_ordinaria += $price_vio;
			/* Determinazione tributo catastale */
			$tributo_catastale_visura_ordinaria += $price_tc_vio;
			/* Definizione ord_vis (S / N) */
		...
		if(isset($_POST['ordine-visura-storica-planimetria-immobile-1'])) {
		...
		if(isset($_POST['ordine-visura-storica-planimetria-immobile-2'])) {
			$prezzo_planimetria_catastale += $price_pln;
			/* Determinazione tributo catastale */
			$tributo_catastale_planimetria += $price_tc_pln;
			/* Definizione ord_map (S / N) */
		...
		$ord_catasto_immobili_1_2 = $ord_catasto_immobile_1 . ' / ' . $ord_catasto_immobile_2;
		...
		VALUES ('$ord_pb', '$ord_sm', '', '$ord_catasto_immobili_1_2', '$ord_pln', '$ord_vio', '$ord_vis', '$ord_map', '$ord_arr', '$urg_name', '$ord_sca', '$ord_token', '$cli_id', '$cliente_titolare_delegato', '$riferimenti_geografici_ord_pro_db', '$riferimenti_geografici_ord_com_db', '$su_immobili_1_2', '$fgl_immobili_1_2', '$par_immobili_1_2', '$sub_immobili_1_2', '$ord_stat', '$ord_price', '$ord_price_eff_finale', '$tributi_catastali_totali', '$spese_finanziarie', '$tasse_contributi', '$profitto_netto', '$ord_deb_cont', '$metodo_pagamento')";
