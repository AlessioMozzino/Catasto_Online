<?php
    ...
    if(isset($_POST['ordina-s-visura-storica'])) {
		...
		/* Estratto di mappa */
		if(isset($_POST['ordine-visura-storica-mappa'])) {
		...
		/* Visura ordinaria */
		if(isset($_POST['ordine-visura-storica-visura-ordinaria'])) {
		...
		if(isset($_POST['ordine-visura-storica-planimetria'])) {
