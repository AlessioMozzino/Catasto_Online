<?php
    ...
    /* Ordinazione visura ordinaria */
    if(isset($_POST['ordina-s-visura-ordinaria'])) {
		...
		/* Estratto di mappa */
		if(isset($_POST['ordine-visura-ordinaria-mappa'])) {
		...
		/* Visura storica */
		if(isset($_POST['ordine-visura-ordinaria-visura-storica'])) {
		...
		if(isset($_POST['ordine-visura-ordinaria-planimetria'])) {
