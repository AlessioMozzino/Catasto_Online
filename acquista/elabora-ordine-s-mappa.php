<?php
    ...
    /* Ordinazione estratto di mappa */
    if(isset($_POST['ordina-s-estratto-mappa'])) {
		...
		$tributo_catastale_mappa = $price_tc_map;

		/* Controllo spunte servizi aggiuntivi per conferma prezzo finale ordine */
		/* Visura ordinaria */
		if(isset($_POST['ordine-mappa-visura-ordinaria'])) {
		...
		/* Visura storica */
		if(isset($_POST['ordine-mappa-visura-storica'])) {
		...
		if(isset($_POST['ordine-mappa-planimetria'])) {
